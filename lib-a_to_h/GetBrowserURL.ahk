; Link:   	https://www.autohotkey.com/boards/viewtopic.php?f=6&t=3702&hilit=nested+class
; Author:	atnbueno (with functions from Sean, AHK_L version by maraskan_user))
; Date:   	2016-05-19
; for:     	AHK_L
