...
class IUIAutomationElement extends IUnknown
{
	...
	CachedLocalizedControlType(){
		UIA_hr(DllCall(this.vt(54),"ptr",this.__
			,"ptr*",retVal
			,"uint"),"get_CachedLocalizedControlType")
		return StrGet(retVal,"utf-16")
	}
	...
	CachedDescribedBy(){
		UIA_hr(DllCall(this.vt(81),"ptr",this.__
			,"ptr*",retVal
			,"uint"),"get_CachedDescribedBy")
		return new IUIAutomationElementArray(retVal) ; IUIAutomationElementArray
	}
	
	; Retrieves a cached array of elements that indicate the reading order after the current element.
	CachedFlowsTo(){
		UIA_hr(DllCall(this.vt(82),"ptr",this.__
			,"ptr*",retVal
			,"uint"),"get_CachedFlowsTo")
		return new IUIAutomationElementArray(retVal) ; IUIAutomationElementArray
	}
	
	; Retrieves a cached description of the provider for this element.
	CachedProviderDescription(){
		UIA_hr(DllCall(this.vt(83),"ptr",this.__
			,"ptr*",retVal
			,"uint"),"get_CachedProviderDescription")
		return StrGet(retVal,"utf-16")
	}
	...
	GetClickablePoint(){
		UIA_hr(DllCall(this.vt(84),"ptr",this.__
			,"int64*",clickable
			,"int*",gotClickable
			,"uint"),"GetClickablePoint")
...
class IUIAutomationCacheRequest extends IUnknown
{
	__get(aName){
		if (aName="TreeScope"){
			UIA_hr(DllCall(this.vt(6),"ptr",this.__
			,"int*",scope,"uint"),"get_TreeScope")
			return scope ; TreeScope
		}else if (aName="TreeFilter"){
			UIA_hr(DllCall(this.vt(8),"ptr",this.__
			,"ptr*",filter,"uint"),"get_TreeFilter")
			return filter ; IUIAutomationCondition
		}else if (aName="AutomationElementMode"){
			UIA_hr(DllCall(this.vt(10),"ptr",this.__
			,"int*",mode,"uint"),"get_AutomationElementMode")
			return mode ; AutomationElementMode
		}
	}
	__set(aName,aValue){
		if (aName="TreeScope")
			return UIA_hr(DllCall(this.vt(7),"ptr",this.__
			,"int",aValue,"uint"),"put_TreeScope")
		else if (aName="TreeFilter")
			return UIA_hr(DllCall(this.vt(9),"ptr",this.__
			,"ptr",aValue,"uint"),"put_TreeFilter") 
		else if (aName="AutomationElementMode")
			return UIA_hr(DllCall(this.vt(11),"ptr",this.__
			,"int",aValue,"uint"),"put_AutomationElementMode")
	}
	...
	AddProperty(propertyId){
		if IsObject(propertyId)
			loop % propertyId.maxindex()
				UIA_hr(DllCall(this.vt(3),"ptr",this.__
				,"int",propertyId[A_Index],"uint"),"AddProperty")
		else return UIA_hr(DllCall(this.vt(3),"ptr",this.__
				,"int",propertyId,"uint"),"AddProperty")
	}
	...
	AddPattern(patternId){
		if IsObject(patternId)
			loop % patternId.maxindex()
				UIA_hr(DllCall(this.vt(4),"ptr",this.__
					,"int",patternId[A_Index]
					,"uint"),"AddPattern")
		else return UIA_hr(DllCall(this.vt(4),"ptr",this.__
					,"int",patternId
					,"uint"),"AddPattern")
	}
...
class IUIAutomationBoolCondition extends IUnknown
{
	; Retrieves the value of the condition: either TRUE or FALSE.
	value(){
		UIA_hr(DllCall(this.vt(3),"ptr",this.__
			,"int*",boolVal
			,"uint"),"get_BooleanValue")
		return boolVal
	}
}

class IUIAutomationPropertyCondition extends IUnknown
{
	...
	flags(){
		UIA_hr(DllCall(this.vt(5),"ptr",this.__
			,"int*",flags,"uint"),"get_PropertyConditionFlags")
		return flags ; PropertyConditionFlags
	}
}

class IUIAutomationAndCondition extends IUnknown
{
...
class IUIAutomationOrCondition extends IUnknown
{
	; Retrieves the number of conditions that make up this condition.
	count(){
		UIA_hr(DllCall(this.vt(3),"ptr",this.__
...
class IUIAutomationNotCondition extends IUnknown
{
...
class IUIAutomationTreeWalker extends IUnknown
{
	...
	GetFirstChildElementBuildCache(element,cacheRequest){
		UIA_hr(DllCall(this.vt(10),"ptr",this.__
			...
			,"ptr",IsObject(cacheRequest)?cacheRequest.__:cacheRequest
			,"ptr*",first
			,"uint"),"FirstChildElementBuildCache")
		return new IUIAutomationElement(first)
	}
	...
	GetLastChildElementBuildCache(element,cacheRequest){
		UIA_hr(DllCall(this.vt(11),"ptr",this.__
			...
			,"ptr",IsObject(cacheRequest)?cacheRequest.__:cacheRequest
			,"ptr*",last
			,"uint"),"LastChildElementBuildCache")
		return new IUIAutomationElement(last)
	}
	...
	GetNextSiblingElementBuildCache(element,cacheRequest){
		UIA_hr(DllCall(this.vt(12),"ptr",this.__
			...
			,"ptr",IsObject(cacheRequest)?cacheRequest.__:cacheRequest
			,"ptr*",next
			,"uint"),"NextSiblingElementBuildCache")
		return new IUIAutomationElement(next)
	}
	...
	GetPreviousSiblingElementBuildCache(element,cacheRequest){
		UIA_hr(DllCall(this.vt(13),"ptr",this.__
			...
			,"ptr",IsObject(cacheRequest)?cacheRequest.__:cacheRequest
			,"ptr*",previous
			,"uint"),"PreviousSiblingElementBuildCache")
		return new IUIAutomationElement(previous)
	}
	...
	NormalizeElementBuildCache(element,cacheRequest){
		UIA_hr(DllCall(this.vt(14),"ptr",this.__
			...
			,"ptr",IsObject(cacheRequest)?cacheRequest.__:cacheRequest
			,"ptr*",normalized
			,"uint"),"NormalizeElementBuildCache")
...
class IUIAutomationInvokePattern extends IUnknown
{
	...
	Invoke(){
		return UIA_hr(DllCall(this.vt(3),"ptr",this.__,"uint"),"Invoke")
	}
...
class IUIAutomationExpandCollapsePattern extends IUnknown
{
	...
	Expand(){
		return UIA_hr(DllCall(this.vt(3),"ptr",this.__,"uint"),"Expand")
	}
	
	; Hides all child nodes, controls, or content of the element.
	Collapse(){
		return UIA_hr(DllCall(this.vt(4),"ptr",this.__,"uint"),"Collapse")
	}
	...
	CurrentExpandCollapseState(){
		UIA_hr(DllCall(this.vt(5),"ptr",this.__
			,"int*",retVal
			,"uint"),"CurrentExpandCollapseState")
	...
	CachedExpandCollapseState(){
		UIA_hr(DllCall(this.vt(6),"ptr",this.__
			,"int*",retVal
			,"uint"),"CachedExpandCollapseState")
		return retVal ; ExpandCollapseState
	}
}
...
class IUIAutomationMultipleViewPattern extends IUnknown
{
	...
	SetCurrentView(view){
		return UIA_hr(DllCall(this.vt(4),"ptr",this.__
			,"int",view
			,"uint"),"SetCurrentView")
	}
...
class IUIAutomationScrollPattern extends IUnknown
{
	...
	CurrentHorizontalScrollPercent(){
		UIA_hr(DllCall(this.vt(5),"ptr",this.__
			,"double*",retVal
			,"uint"),"CurrentHorizontalScrollPercent")
		return retVal
	}
	...
	CurrentVerticalScrollPercent(){
		UIA_hr(DllCall(this.vt(6),"ptr",this.__
			,"double*",retVal
			,"uint"),"CurrentVerticalScrollPercent")
		return retVal
	}
	...
	CurrentHorizontalViewSize(){
		UIA_hr(DllCall(this.vt(7),"ptr",this.__
			,"double*",retVal
			,"uint"),"CurrentHorizontalViewSize")
		return retVal
	}
	...
	CurrentHorizontallyScrollable(){
		UIA_hr(DllCall(this.vt(9),"ptr",this.__
			,"int*",retVal
			,"uint"),"CurrentHorizontallyScrollable")
		return retVal
	}
	...
	CurrentVerticallyScrollable(){
		UIA_hr(DllCall(this.vt(10),"ptr",this.__
			,"int*",retVal
			,"uint"),"CurrentVerticallyScrollable")
		return retVal
	}
	...
	CachedHorizontalScrollPercent(){
		UIA_hr(DllCall(this.vt(11),"ptr",this.__
			,"double*",retVal
			,"uint"),"CachedHorizontalScrollPercent")
		return retVal
	}
	...
	CachedVerticalScrollPercent(){
		UIA_hr(DllCall(this.vt(12),"ptr",this.__
			,"double*",retVal
			,"uint"),"CachedVerticalScrollPercent")
		return retVal
	}
	...
	CachedHorizontallyScrollable(){
		UIA_hr(DllCall(this.vt(15),"ptr",this.__
			,"int*",retVal
			,"uint"),"CachedHorizontallyScrollable")
		return retVal
	}
	...
	CachedVerticallyScrollable(){
		UIA_hr(DllCall(this.vt(16),"ptr",this.__
			,"int*",retVal
			,"uint"),"CachedVerticallyScrollable")
		return retVal
	}
}
...
class IUIAutomationSelectionPattern extends IUnknown
{
	...
	CurrentIsSelectionRequired(){
		UIA_hr(DllCall(this.vt(5),"ptr",this.__
			,"int*",retVal
			,"uint"),"CurrentIsSelectionRequired")
		return retVal
	}
	...
	CachedIsSelectionRequired(){
		UIA_hr(DllCall(this.vt(8),"ptr",this.__
			,"int*",retVal
			,"uint"),"CachedIsSelectionRequired")
		return retVal
	}
}
class IUIAutomationSelectionItemPattern extends IUnknown
{
	...
	RemoveFromSelection(){
		return UIA_hr(DllCall(this.vt(5),"ptr",this.__
			,"uint"),"RemoveFromSelection")
	}
	...
	CurrentSelectionContainer(){
		UIA_hr(DllCall(this.vt(7),"ptr",this.__
			,"ptr*",retVal
			,"uint"),"CurrentSelectionContainer")
		return retVal
	}
...
class IUIAutomationSynchronizedInputPattern extends IUnknown
{
	...
	StartListening(inputType){ ; SynchronizedInputType
		return UIA_hr(DllCall(this.vt(3),"ptr",this.__
			,"int",inputType,"uint"),"StartListening")
	}
...
class IUIAutomationTableItemPattern extends IUnknown
{
	...
	GetCurrentColumnHeaderItems(){
		UIA_hr(DllCall(this.vt(4),"ptr",this.__
			,"ptr*",retVal
			,"uint"),"GetCurrentColumnHeaderItems")
		return new IUIAutomationElementArray(retVal)
	}
	...
	GetCachedColumnHeaderItems(){
		UIA_hr(DllCall(this.vt(6),"ptr",this.__
			,"ptr*",retVal
			,"uint"),"GetCachedColumnHeaderItems")
		return new IUIAutomationElementArray(retVal)
	}
}
...
class IUIAutomationWindowPattern extends IUnknown
{
	...
	WaitForInputIdle(milliseconds){
		UIA_hr(DllCall(this.vt(4),"ptr",this.__
			,"int",milliseconds,"int*",success,"uint"),"WaitForInputIdle")
		return success
	}
	...
	SetWindowVisualState(state){
		UIA_hr(DllCall(this.vt(5),"ptr",this.__
			,"int",state,"uint"),"SetWindowVisualState")
		return 
	}
	...
	CurrentWindowInteractionState(){
		UIA_hr(DllCall(this.vt(11),"ptr",this.__
			,"int*",retVal
			,"uint"),"CurrentWindowInteractionState")
	...
	CachedWindowInteractionState(){
		UIA_hr(DllCall(this.vt(17),"ptr",this.__
			,"int*",retVal
			,"uint"),"CachedWindowInteractionState")
		return retVal ; WindowInteractionState
	}
}
class IUIAutomationTextRangePattern extends IUnknown
{
	...
	Compare(range){
		UIA_hr(DllCall(this.vt(4),"ptr",this.__
			,"ptr",IsObject(range)?range.__:range
			,"int*",areSame
			,"uint"),"Compare")
		return areSame
	}
	...
	CompareEndpoints(srcEndPoint,range,targetEndPoint){
		UIA_hr(DllCall(this.vt(5),"ptr",this.__
			...
			,"int",targetEndPoint
			,"int*",compValue
			,"uint"),"CompareEndpoints") ; TextPatternRangeEndpoint
		return compValue
	}
	...
	ExpandToEnclosingUnit(textUnit){ ; textUnit
		return UIA_hr(DllCall(this.vt(6),"ptr",this.__
			,"int",textUnit
			,"uint"),"ExpandToEnclosingUnit") ; textUnit
	}
	...
	FindAttribute(attr,val,backward){
		UIA_hr(DllCall(this.vt(7),"ptr",this.__
			,"int",attr
			,"ptr",variant(v,UIA_AttributeVariantType(attr),val)
			,"int",backward
			,"ptr*",found
			,"uint"),"FindAttribute")
	...
	GetAttributeValue(attr,value){
		UIA_hr(DllCall(this.vt(9),"ptr",this.__
			,"int",attr
			,"ptr",variant(value)
			,"uint"),"GetAttributeValue") ; Text Attribute
	...
	*/
	...
	MoveEndpointByUnit(endpoint,unit,count){ ; TextPatternRangeEndpoint , TextUnit
		UIA_hr(DllCall(this.vt(14),"ptr",this.__
			...
			,"int",count
			,"int*",moved
			,"uint"),"MoveEndpointByUnit") ; TextPatternRangeEndpoint,TextUnit
		return moved
	}
	...
	MoveEndpointByRange(srcEndPoint,range,targetEndPoint){ ; TextPatternRangeEndpoint , IUIAutomationTextRange , TextPatternRangeEndpoint
		return UIA_hr(DllCall(this.vt(15),"ptr",this.__
			,"int",srcEndPoint
			,"ptr",IsObject(range)?range.__:range
			,"int",targetEndPoint
			,"uint"),"MoveEndpointByRange")
	}
	...
	Select(){
		return UIA_hr(DllCall(this.vt(16),"ptr",this.__,"uint"),"Select")
	}
	...
	AddToSelection(){
		return UIA_hr(DllCall(this.vt(17),"ptr",this.__,"uint"),"AddToSelection")
	}
	...
	RemoveFromSelection(){
		return UIA_hr(DllCall(this.vt(18),"ptr",this.__,"uint"),"RemoveFromSelection")
	}
	...
	ScrollIntoView(alignToTop){
		return UIA_hr(DllCall(this.vt(19),"ptr",this.__,"int",alignToTop,"uint"),"ScrollIntoView")
	}
...
class IUIAutomationTextRangeArrayPattern extends IUnknown
{
...
class IUIAutomationTextPattern extends IUnknown
{
	...
	*/
	...
	RangeFromChild(child){ ; IUIAutomationElement
		UIA_hr(DllCall(this.vt(4),"ptr",this.__
			,"ptr",IsObject(child)?child.__:child
			,"ptr*",range
			,"uint"),"RangeFromChild")
		return new IUIAutomationTextRange(range)
	}
	...
	SupportedTextSelection(){
		UIA_hr(DllCall(this.vt(8),"ptr",this.__
			,"int*",supportedTextSelection
			,"uint"),"SupportedTextSelection")
...
; IUIAutomationLegacyIAccessiblePattern
	...
	DoDefaultAction(){
		return UIA_hr(DllCall(this.vt(4),"ptr",this.__,"uint"),"DoDefaultAction")
	}
	...
	SetValue(szValue){
		return UIA_hr(DllCall(this.vt(5),"ptr",this.__,"str",szValue,"uint"),"SetValue")
	}
...
class IUIAutomationItemContainerPattern extends IUnknown
{
	...
	FindItemByProperty(pStartAfter,propertyId,value){ ; IUIAutomationElement
		UIA_hr(DllCall(this.vt(3),"ptr",this.__
			,"ptr",IsObject(pStartAfter)?pStartAfter.__:pStartAfter
			,"int",propertyId
			,"ptr",variant(_,UIA_PropertyVariantType(propertyId),value)
			,"ptr*",pFound
			,"uint"),"FindItemByProperty")
...
class IUIAutomationVirtualizedItemPattern extends IUnknown
{
	...
	Realize(){
		return UIA_hr(DllCall(this.vt(3),"ptr",this.__,"uint"),"Realize")
	}
}
