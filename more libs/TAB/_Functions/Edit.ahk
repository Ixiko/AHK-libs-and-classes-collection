/*
    v2.1 (or v2.0.x) changes.
*/

/*
Title: Edit Library v2.0.1
...
;-- ##### UC
;-- ##### UC
;-- ##### Remove all of the outputdebug commands before publishing
;-----------------------------
;
...
;-- ##### Some debugging code persists.  Remove before publishing.
...
Edit_ReadFile(hEdit,p_File,p_Encoding="",p_Convert2DOS=False,ByRef r_EOLFormat="")
    ...
    outputdebug % "File.Encoding: " . File.Encoding
