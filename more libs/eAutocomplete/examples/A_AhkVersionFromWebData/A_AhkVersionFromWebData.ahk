...
*/
	...
	if (_suggestion = "A_AHKVersion") { ; if the selected suggestion appears to be 'A_AHKVersion'...
...
*/
	local
	if (StrLen(_version:=onReplacement(_selectionText)))
		return _version . " (version retrieved from the url https://www.autohotkey.com/download/1.1/version.txt)"
}
