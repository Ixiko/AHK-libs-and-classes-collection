...
; AHK version:			2.0-a080-d1c5ddf   (AHK_L)
; Language:				English
; Version:				1.0.0.00/2017-09-13/hoppfrosch
...
; Styles === (winuser.h) ===============================================================================================
class WS {
	; https://msdn.microsoft.com/de-de/library/windows/desktop/ms632600(v=vs.85).aspx 
...
; System Metrics constants =========================== (winuser.h) =====================================================
class SM {
	; https://msdn.microsoft.com/en-us/library/ms724385
	static CXSCREEN					:= 0x0
	static CYSCREEN					:= 0x1
	static CXVSCROLL				:= 0x2
	static CYHSCROLL				:= 0x3
	static CYCAPTION				:= 0x4
	static CXBORDER					:= 0x5
	static CYBORDER					:= 0x6
	static CXDLGFRAME				:= 0x7
	static CYDLGFRAME				:= 0x8
	static CXFIXEDFRAME				:= 0x7  ;win40 name change
	static CYFIXEDFRAME				:= 0x8  ;win40 name change
	static CYVTHUMB					:= 0x9
	static CXHTHUMB					:= 0x10
	static CXICON					:= 0x11
	static CYICON					:= 0x12
	static CXCURSOR					:= 0x13
	static CYCURSOR					:= 0x14
	static CYMENU					:= 0x15
	static CXFULLSCREEN				:= 0x16
	static CYFULLSCREEN				:= 0x17
	static CYKANJIWINDOW			:= 0x18
	static MOUSEPRESENT				:= 0x19
	static CYVSCROLL				:= 0x20
	static CXHSCROLL				:= 0x21
	static DEBUG					:= 0x22
	static SWAPBUTTON				:= 0x23
	static RESERVED1				:= 0x24
	static RESERVED2				:= 0x25
	static RESERVED3				:= 0x26
	static RESERVED4				:= 0x27
	static CXMIN					:= 0x28
	static CYMIN					:= 0x29
	static CXSIZE					:= 0x30
	static CYSIZE					:= 0x31
	static CXFRAME					:= 0x32
	static CYFRAME					:= 0x33
	static CXSIZEFRAME				:= 0x32  ;win40 name change
	static CYSIZEFRAME				:= 0x33  ;win40 name change
	static CXMINTRACK				:= 0x34
	static CYMINTRACK				:= 0x35
	static CXDOUBLECLK				:= 0x36
	static CYDOUBLECLK				:= 0x37
	static CXICONSPACING			:= 0x38
	static CYICONSPACING			:= 0x39
	static MENUDROPALIGNMENT		:= 0x40
	static PENWINDOWS				:= 0x41
	static DBCSENABLED				:= 0x42
	static CMOUSEBUTTONS			:= 0x43
	static SECURE					:= 0x44
	static CXEDGE					:= 0x45
	static CYEDGE					:= 0x46
	static CXMINSPACING				:= 0x47
	static CYMINSPACING				:= 0x48
	static CXSMICON					:= 0x49
	static CYSMICON					:= 0x50
	static CYSMCAPTION				:= 0x51
	static CXSMSIZE					:= 0x52
	static CYSMSIZE					:= 0x53
	static CXMENUSIZE				:= 0x54
	static CYMENUSIZE				:= 0x55
	static ARRANGE					:= 0x56
	static CXMINIMIZED				:= 0x57
	static CYMINIMIZED				:= 0x58
	static CXMAXTRACK				:= 0x59
	static CYMAXTRACK				:= 0x60
	static CXMAXIMIZED				:= 0x61
	static CYMAXIMIZED				:= 0x62
	static NETWORK					:= 0x63
	static CLEANBOOT				:= 0x67
	static CXDRAG					:= 0x68
	static CYDRAG					:= 0x69
	static SHOWSOUNDS				:= 0x70
	static CXMENUCHECK				:= 0x71   ; useinstead of GetMenuCheckMarkDimensions()!
	static CYMENUCHECK				:= 0x72
	static SLOWMACHINE				:= 0x73
	static MIDEASTENABLED			:= 0x74
	static MOUSEWHEELPRESENT		:= 0x75
	static XVIRTUALSCREEN			:= 0x76
	static YVIRTUALSCREEN			:= 0x77
	static CXVIRTUALSCREEN			:= 0x78
	static CYVIRTUALSCREEN			:= 0x79
	static CMONITORS				:= 0x80
	static SAMEDISPLAYFORMAT		:= 0x81
	static IMMENABLED				:= 0x82
	static CXFOCUSBORDER			:= 0x83
	static CYFOCUSBORDER			:= 0x84
	static TABLETPC					:= 0x86
	static MEDIACENTER				:= 0x87
	static STARTER					:= 0x88
	static SERVERR2					:= 0x89
	static MOUSEHORIZONTALWHEELPRESENT := 0x91
	static CXPADDEDBORDER			:= 0x92
	static DIGITIZER				:= 0x94
	static MAXIMUMTOUCHES			:= 0x95
} 