...
;{ Class comments
/*!
	Class: MfNotSupportedException
		The exception that is thrown when an invoked method is not supported.
	Inherits:
		MfSystemException
*/
;	End:Class comments ;}
class MfNotSupportedException extends MfSystemException
{
;{ Constructor
/*
	Method: Constructor()

	OutputVar := new MfNotSupportedException()
	OutputVar := new MfNotSupportedException(message)
	OutputVar := new MfNotSupportedException(message, innerException)

	Constructor()
		Initializes a new instance of the MfNotSupportedException class.
	Remarks:
	...
	Constructor(message)
		Initializes a new instance of MfNotSupportedException class with a specified error message

	Constructor(message, innerException)
		Initializes a new instance of MfNotSupportedException class with a specified error message and a reference to the
...
*/
	__New(message = "", innerException = "") {
		...
		if (String.IsNullOrEmpty(_msg)) {
			_msg := MfEnvironment.Instance.GetResourceString("Arg_NotSupportedException")
		}
		base.__New(_msg,innerException)
		this.m_isInherited := this.__Class != "MfNotSupportedException"
