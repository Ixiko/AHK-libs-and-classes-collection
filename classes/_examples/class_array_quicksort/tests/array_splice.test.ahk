group := tester.newGroup("array_splice(ByRef array, start, deleteCount:=-1, args*)")


; test subgroup 1
desc := "Starting position only"
array := ["a","b","c","d","e","f"]
spliced := array_splice(array, 3)
...
array := ["a","b","c","d","e","f"]
spliced := array_splice(array, 3, 2)
...
array := ["a","b","c","d","e","f"]
spliced := array_splice(array, 3, 0)
...
array := ["a","b","c","d","e","f"]
spliced := array_splice(array, 3, 2, "g", "h")
...
array := ["a","b","c","d","e","f"]
spliced := array_splice(array, 3, 0, "g", "h")
