...
DecodedBytes:=LC_ASCII85_Decode(RegExReplace(Logo, "\s"))
...
Gui, Add, Text, x10 y10 w228 h133 , % "Size: " obj.GetCapicity()
...
Gdip_SaveBitmapToFile(pBitmap, "F:\Streams\testBitmap.bmp")
...
#include %A_ScriptDir%\..\g-n\gdip.ahk
