...
Gui, 1: Show, % "x" Floor(A_Screenwidth//2) " y" Floor(A_ScreenHeight//2) " NA"
Gui, 1: +Lastfound
...
pBitmap := Gdip_CreateBitmapFromFile(A_ScriptDir "\background.png")
...
WinMove,,, Floor(A_Screenwidth//2) - Width//2, Floor(A_ScreenHeight//2) - Height//2
Return
