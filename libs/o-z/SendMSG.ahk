...
if isnot(msg,"xdigit") and is(%msg%,"xdigit")
msg:=%msg%
; msg(msg "=" (isnot(msg,"xdigit")?" isnot(msg,xdigit) ":" is(msg,xdigit) "))
; msg(msg " is(%msg%,xdigit) " is(%msg%,"xdigit"))
SendMessage,% Msg,% wParam,% &lParam,% Control,% WinTitle,% WinText,% ExcludeTitle,% ExcludeText,% Timeout

return MsgReply := ErrorLevel << 32 >> 32
}
