...
; Use F1 and F2 to show msgboxes.
; This is a poor example, because when the msgbox is shown, we cannot recieve incomming messages needed for button callbacks or restoring some settings if the taskbar (icon) is destroyed.
