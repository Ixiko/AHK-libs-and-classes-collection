...
;
;           Some CLI programs, for some reason, will output data to the console in PowerShell but not
;           in the CMD window.  So if you are trying to caputre data, and you can't find it in stdout
;           and you can't find it even in the console when using CMD, try using PowerShell.
;
