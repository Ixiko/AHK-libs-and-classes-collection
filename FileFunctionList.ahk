; AHK-Library Functionlist 09.12.2018
...
;Functions:
0034 | ExtListView_GetSingleItem(ByRef objLV, sState, nCol)
0127 | ExtListView_GetItemText(ByRef objLV, nRow, nCol)
0213 | ExtListView_DeInitialize(ByRef objLV)
0227 | ExtListView_CheckInitObject(ByRef objLV)
0236 | __ExtListView_AllocateMemory(ByRef objLV)
0252 | __ExtListView_DeAllocateMemory(ByRef objLV)
...
;Functions:
0113 | ObjGetCount(BaseObject)
0138 | ObjMerge(SourceObject, TargetObject, Mode="", CallBack="")
0201 | ObjToStr(InObject, Depth=1)
0261 | ObjToTreeView(InObject, FormatFunc=0, MaxDepth=0, Depth=1, Parent=0)
0330 | ObjToXML(InObject, Depth=1)
0376 | XMLToObj(BaseObject, InString)
0434 | ObjSave(InObject, FileName, Mode="w")
0460 | ObjLoad(BaseObject, FileName)
...
;Functions:
0112 | TrayIcon_Remove(hWnd, uID)
0154 | TrayIcon_GetTrayBar()
0180 | TrayIcon_GetHotItem()
...
;Functions:
0011 | __New(settings=false)
0015 | combine(downKey, upKey, settings=false)
0029 | comboKey(remappingKey=false)
0041 | reset()
0049 | combo(justReleasedDownKeyTimeDown=-1)
0094 | modifier(remappingKey=false)
...
0153 | getKeysFor(currentKey, downKey, upKey, settings)
0165 | __New(downKey, upKey, defaults, settings)
0173 | abortDualRole()
0185 | __New(key)
0202 | down(sendActualKeyStrokes=true)
0234 | up(sendOnly=false)
0251 | send()
0262 | timeDown()
0267 | timeSinceLastUp()
0272 | keydown(keys, currentKey, lastKey)
0300 | keyup(keys, currentKey, lastKey)
0337 | cleanKey(key)
0342 | sendInternal(string)
0350 | override(master, extension, options=false)
0368 | timeSince(time)
...
0133 | Get(Key)
0148 | Delete(Key)
0197 | __New(HashTable)
0208 | Next(byref Key, byref Value)
0230 | _NewEnum()
0237 | Clone()
...
;}
;{ [1177] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1178] classes\COM-Classes-FrameWork 
...
;}
;{ [1179] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1180] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1181] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1182] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1183] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1184] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1185] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1186] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1187] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1188] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1189] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1190] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1191] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1192] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1193] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1194] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1195] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1196] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1197] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1198] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1199] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1200] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1201] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1202] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1203] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1204] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1205] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1206] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1207] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1208] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1209] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1210] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1211] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1212] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1213] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1214] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1215] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1216] classes\COM-Classes-FrameWork 

;Functions:

;}
;{ [1217] classes\COM-Classes-FrameWork 
...
;}
;{ [1369] more libs\COM-Classes-master 

;Functions:

;}
;{ [1370] more libs\COM-Classes-master 
...
;}
;{ [1371] more libs\COM-Classes-master 

;Functions:

;}
;{ [1372] more libs\COM-Classes-master 

;Functions:

;}
;{ [1373] more libs\COM-Classes-master 

;Functions:

;}
;{ [1374] more libs\COM-Classes-master 

;Functions:

;}
;{ [1375] more libs\COM-Classes-master 

;Functions:

;}
;{ [1376] more libs\COM-Classes-master 

;Functions:

;}
;{ [1377] more libs\COM-Classes-master 

;Functions:

;}
;{ [1378] more libs\COM-Classes-master 

;Functions:

;}
;{ [1379] more libs\COM-Classes-master 

;Functions:

;}
;{ [1380] more libs\COM-Classes-master 

;Functions:

;}
;{ [1381] more libs\COM-Classes-master 

;Functions:

;}
;{ [1382] more libs\COM-Classes-master 

;Functions:

;}
;{ [1383] more libs\COM-Classes-master 

;Functions:

;}
;{ [1384] more libs\COM-Classes-master 

;Functions:

;}
;{ [1385] more libs\COM-Classes-master 

;Functions:

;}
;{ [1386] more libs\COM-Classes-master 

;Functions:

;}
;{ [1387] more libs\COM-Classes-master 

;Functions:

;}
;{ [1388] more libs\COM-Classes-master 

;Functions:

;}
;{ [1389] more libs\COM-Classes-master 

;Functions:

;}
;{ [1390] more libs\COM-Classes-master 

;Functions:

;}
;{ [1391] more libs\COM-Classes-master 

;Functions:

;}
;{ [1392] more libs\COM-Classes-master 

;Functions:

;}
;{ [1393] more libs\COM-Classes-master 

;Functions:

;}
;{ [1394] more libs\COM-Classes-master 

;Functions:

;}
;{ [1395] more libs\COM-Classes-master 

;Functions:

;}
;{ [1396] more libs\COM-Classes-master 

;Functions:

;}
;{ [1397] more libs\COM-Classes-master 

;Functions:

;}
;{ [1398] more libs\COM-Classes-master 

;Functions:

;}
;{ [1399] more libs\COM-Classes-master 

;Functions:

;}
;{ [1400] more libs\COM-Classes-master 

;Functions:

;}
;{ [1401] more libs\COM-Classes-master 

;Functions:

;}
;{ [1402] more libs\COM-Classes-master 

;Functions:

;}
;{ [1403] more libs\COM-Classes-master 

;Functions:

;}
;{ [1404] more libs\COM-Classes-master 

;Functions:

;}
;{ [1405] more libs\COM-Classes-master 

;Functions:

;}
;{ [1406] more libs\COM-Classes-master 

;Functions:

;}
;{ [1407] more libs\COM-Classes-master 

;Functions:

;}
;{ [1408] more libs\COM-Classes-master 

;Functions:

;}
;{ [1409] more libs\COM-Classes-master 

;Functions:

;}
;{ [1410] more libs\COM-Classes-master 

;Functions:

;}
;{ [1411] more libs\COM-Classes-master 

;Functions:

;}
;{ [1412] more libs\COM-Classes-master 

;Functions:

;}
;{ [1413] more libs\COM-Classes-master 

;Functions:

;}
;{ [1414] more libs\COM-Classes-master 

;Functions:

;}
;{ [1415] more libs\COM-Classes-master 

;Functions:

;}
;{ [1416] more libs\COM-Classes-master 

;Functions:

;}
;{ [1417] more libs\COM-Classes-master 

;Functions:

;}
;{ [1418] more libs\COM-Classes-master 

;Functions:

;}
;{ [1419] more libs\COM-Classes-master 

;Functions:

;}
;{ [1420] more libs\COM-Classes-master 

;Functions:

;}
;{ [1421] more libs\COM-Classes-master 

;Functions:

;}
;{ [1422] more libs\COM-Classes-master 

;Functions:

;}
;{ [1423] more libs\COM-Classes-master 

;Functions:

;}
;{ [1424] more libs\COM-Classes-master 

;Functions:

;}
;{ [1425] more libs\COM-Classes-master 

;Functions:

;}
;{ [1426] more libs\COM-Classes-master 

;Functions:

;}
;{ [1427] more libs\COM-Classes-master 

;Functions:

;}
;{ [1428] more libs\COM-Classes-master 

;Functions:

;}
;{ [1429] more libs\COM-Classes-master 

;Functions:

;}
;{ [1430] more libs\COM-Classes-master 

;Functions:

;}
;{ [1431] more libs\COM-Classes-master 

;Functions:

;}
;{ [1432] more libs\COM-Classes-master 

;Functions:

;}
;{ [1433] more libs\COM-Classes-master 

;Functions:

;}
;{ [1434] more libs\COM-Classes-master 

;Functions:

;}
;{ [1435] more libs\COM-Classes-master 

;Functions:

;}
;{ [1436] more libs\COM-Classes-master 

;Functions:

;}
;{ [1437] more libs\COM-Classes-master 

;Functions:

;}
;{ [1438] more libs\COM-Classes-master 

;Functions:

;}
;{ [1439] more libs\COM-Classes-master 

;Functions:

;}
;{ [1440] more libs\COM-Classes-master 

;Functions:

;}
;{ [1441] more libs\COM-Classes-master 

;Functions:

;}
;{ [1442] more libs\COM-Classes-master 

;Functions:

;}
;{ [1443] more libs\COM-Classes-master 

;Functions:

;}
;{ [1444] more libs\COM-Classes-master 

;Functions:

;}
;{ [1445] more libs\COM-Classes-master 
...
;}
;{ [1446] more libs\COM-Classes-master 
...
;}
;{ [1447] more libs\COM-Classes-master 
...
;}
;{ [1448] more libs\COM-Classes-master 
...
;}
;{ [1449] more libs\COM-Classes-master 
...
;}
;{ [1450] more libs\COM-Classes-master 

;Functions:

;}
;{ [1451] more libs\COM-Classes-master 
...
;}
;{ [1452] more libs\COM-Classes-master 
...
;}
;{ [1453] more libs\COM-Classes-master 
...
;}
;{ [1454] more libs\COM-Classes-master 
...
;}
;{ [1455] more libs\COM-Classes-master 
...
;}
;{ [1456] more libs\COM-Classes-master 
...
;}
;{ [1457] more libs\COM-Classes-master 
...
;}
;{ [1458] more libs\COM-Classes-master 

;Functions:

;}
;{ [1459] more libs\COM-Classes-master 

;Functions:
0042 | GetClassID()

;}
;{ [1460] more libs\COM-Classes-master 
...
;}
;{ [1461] more libs\COM-Classes-master 
...
;}
;{ [1462] more libs\COM-Classes-master 
...
;}
;{ [1463] more libs\COM-Classes-master 

;Functions:

;}
;{ [1464] more libs\COM-Classes-master 
...
;}
;{ [1465] more libs\COM-Classes-master 
...
;}
;{ [1466] more libs\COM-Classes-master 

;Functions:
0042 | GetClassInfo()

;}
;{ [1467] more libs\COM-Classes-master 
...
;}
;{ [1468] more libs\COM-Classes-master 

;Functions:

;}
;{ [1469] more libs\COM-Classes-master 

;Functions:

;}
;{ [1470] more libs\COM-Classes-master 
...
;}
;{ [1471] more libs\COM-Classes-master 

;Functions:

;}
;{ [1472] more libs\COM-Classes-master 
...
;}
;{ [1473] more libs\COM-Classes-master 

;Functions:

;}
;{ [1474] more libs\COM-Classes-master 
...
;}
;{ [1475] more libs\COM-Classes-master 

;Functions:

;}
;{ [1476] more libs\COM-Classes-master 
...
;}
;{ [1477] more libs\COM-Classes-master 
...
;}
;{ [1478] more libs\COM-Classes-master 

;Functions:

;}
;{ [1479] more libs\COM-Classes-master 

;Functions:

;}
;{ [1480] more libs\COM-Classes-master 

;Functions:

;}
;{ [1481] more libs\COM-Classes-master 

;Functions:

;}
;{ [1482] more libs\COM-Classes-master 

;Functions:

;}
;{ [1483] more libs\COM-Classes-master 

;Functions:

;}
;{ [1484] more libs\COM-Classes-master 

;Functions:

;}
;{ [1485] more libs\COM-Classes-master 

;Functions:
0116 | FromSYSTEMTIME(src)

;}
;{ [1486] more libs\COM-Classes-master 

;Functions:

;}
;{ [1487] more libs\COM-Classes-master 

;Functions:

;}
;{ [1488] more libs\COM-Classes-master 

;Functions:

;}
;{ [1489] more libs\COM-Classes-master 

;Functions:

;}
;{ [1490] more libs\COM-Classes-master 

;Functions:

;}
;{ [1491] more libs\COM-Classes-master 

;Functions:

;}
;{ [1492] more libs\COM-Classes-master 

;Functions:

;}
;{ [1493] more libs\COM-Classes-master 

;Functions:

;}
;{ [1494] more libs\COM-Classes-master 

;Functions:

;}
;{ [1495] more libs\COM-Classes-master 

;Functions:

;}
;{ [1496] more libs\COM-Classes-master 

;Functions:

;}
;{ [1497] more libs\COM-Classes-master 

;Functions:

;}
;{ [1498] more libs\COM-Classes-master 

;Functions:

;}
;{ [1499] more libs\COM-Classes-master 

;Functions:

;}
;{ [1500] more libs\COM-Classes-master 

;Functions:

;}
;{ [1501] more libs\COM-Classes-master 

;Functions:

;}
;{ [1502] more libs\COM-Classes-master 

;Functions:

;}
;{ [1503] more libs\COM-Classes-master 

;Functions:

;}
;{ [1504] more libs\COM-Classes-master 
...
;}
;{ [1505] more libs\COM-Classes-master 

;Functions:
0159 | FromFILETIME(src)

;}
;{ [1506] more libs\COM-Classes-master 

;Functions:

;}
;{ [1507] more libs\COM-Classes-master 

;Functions:

;}
;{ [1508] more libs\COM-Classes-master 

;Functions:

;}
;{ [1509] more libs\COM-Classes-master 

;Functions:

;}
;{ [1510] more libs\COM-Classes-master 

;Functions:

;}
;{ [1511] more libs\COM-Classes-master 

;Functions:

;}
;{ [1512] more libs\COM-Classes-master 
...
;}
;{ [1513] more libs\COM-Classes-master 

;Functions:

;}
;{ [1514] more libs\COM-Classes-master 

;Functions:
0053 | MarkFullScreen(hWin, ApplyRemove)

;}
;{ [1515] more libs\COM-Classes-master 
...
;}
;{ [1516] more libs\COM-Classes-master 

;Functions:

;}
;{ [1517] more libs\COM-Classes-master 
...
;}
;{ [1518] more libs\COM-Classes-master 

;Functions:
0056 | SetTabProperties(hTab, properties)

;}
;{ [1519] more libs\COM-Classes-master 

;Functions:

;}
;{ [1520] more libs\COM-Classes-master 
...
;}
;{ [1521] more libs\COM-Classes-master 
...
;}
;{ [1522] more libs\COM-Classes-master 
...
;}
;{ [1523] more libs\COM-Classes-master 
...
;}
;{ [1524] more libs\COM-Classes-master 
...
;}
;{ [1525] more libs\COM-Classes-master 

;Functions:

;}
;{ [1526] more libs\COM-Classes-master 
...
;}
;{ [1527] more libs\COM-Classes-master 

;Functions:
0041 | GetChild()

;}
;{ [1528] more libs\COM-Classes-master 
...
;}
;{ [1529] more libs\DirectX 

;Functions:

;}
;{ [1530] more libs\DirectX 

;Functions:

;}
;{ [1531] more libs\DirectX 

;Functions:
0010 | IVideoWindow_SetWindowPosition(p1, p2, p3, p4, p5)

;}
;{ [1532] more libs\DirectX 

;Functions:

;}
;{ [1533] more libs\DirectX 

;Functions:
0004 | print(msg = "")

;}
;{ [1534] more libs\DirectX 
...
;}
;{ [1535] more libs\DirectX 

;Functions:
0010 | InstallGlHook(function, GDI=False)

;}
;{ [1536] more libs\DirectX 
...
;}
;{ [1537] more libs\DirectX 

;Functions:
0036 | launchTarget()

;}
;{ [1538] more libs\DirectX 

;Functions:

;}
;{ [1539] more libs\DirectX 

;Functions:

;}
;{ [1540] more libs\DirectX 

;Functions:

;}
;{ [1541] more libs\DirectX 

;Functions:

;}
;{ [1542] more libs\DirectX 

;Functions:

;}
;{ [1543] more libs\DirectX 

;Functions:

;}
;{ [1544] more libs\DirectX 

;Functions:

;}
;{ [1545] more libs\DirectX 

;Functions:

;}
;{ [1546] more libs\DirectX 

;Functions:

;}
;{ [1547] more libs\DirectX 

;Functions:

;}
;{ [1548] more libs\DirectX 

;Functions:

;}
;{ [1549] more libs\DirectX 

;Functions:

;}
;{ [1550] more libs\DirectX 

;Functions:

;}
;{ [1551] more libs\DirectX 
...
;}
;{ [1553] more libs\DirectX 

;Functions:
0002 | _5thpass()

;}
;{ [1554] more libs\DirectX 

;Functions:

;}
;{ [1555] more libs\DirectX 

;Functions:

;}
;{ [1556] more libs\DirectX 

;Functions:

;}
;{ [1557] more libs\DirectX 

;Functions:

;}
;{ [1558] more libs\DirectX 

;Functions:

;}
;{ [1559] more libs\DirectX 

;Functions:

;}
;{ [1560] more libs\DirectX 

;Functions:

;}
;{ [1561] more libs\DirectX 
...
;}
;{ [1566] more libs\DirectX 

;Functions:
0005 | IDirectDrawSurface2_lock(p1, p2, p3, p4, p5)

;}
;{ [1567] more libs\DirectX 
...
;}
;{ [1571] more libs\DoDragAndDrop 

;Functions:
0050 | DoDragDrop_GetBitmapSize(HBITMAP, ByRef W, ByRef H)

;}
;{ [1572] more libs\DoDragAndDrop 
...
;}
;{ [1573] more libs\DoDragAndDrop 

;Functions:

;}
;{ [1574] more libs\DoDragAndDrop 
...
;}
;{ [1575] more libs\DoDragAndDrop 

;Functions:

;}
;{ [1576] more libs\DoDragAndDrop 
...
;}
;{ [1579] more libs\DoDragAndDrop 

;Functions:
0026 | SHDataObject_DragImageFromBitmap(DataObj, HBITMAP)

;}
;{ [1580] more libs\DoDragAndDrop 

;Functions:

;}
;{ [1581] more libs\DoDragAndDrop 

;Functions:

;}
;{ [1582] more libs\DX9-Overlay-API 
...
;}
;{ [1583] more libs\DX9-Overlay-API 
...
;}
;{ [1584] more libs\DX9-Overlay-API 
...
;}
;{ [1585] more libs\DX9-Overlay-API 
...
;}
;{ [1586] more libs\DX9-Overlay-API 

;Functions:

;}
;{ [1587] more libs\DX9-Overlay-API 
...
;}
;{ [1632] more libs\ImportTypeLib-master 

;Functions:
0011 | ImportTypeLib(lib, version = "1.0")

;}
;{ [1633] more libs\ImportTypeLib-master 

;Functions:

;}
;{ [1634] more libs\ImportTypeLib-master 

;Functions:

;}
;{ [1635] more libs\ImportTypeLib-master 

;Functions:
0001 | ITL_CoClassConstructor(this, iid = 0)

;}
;{ [1636] more libs\ImportTypeLib-master 

;Functions:
0003 | __New(typeInfo, lib)

;}
;{ [1637] more libs\ImportTypeLib-master 
...
;}
;{ [1638] more libs\ImportTypeLib-master 

;Functions:
0003 | __New(typeInfo, lib)

;}
;{ [1639] more libs\ImportTypeLib-master 

;Functions:
0001 | ITL_InterfaceConstructor(this, instance)

;}
;{ [1640] more libs\ImportTypeLib-master 
...
;}
;{ [1641] more libs\ImportTypeLib-master 

;Functions:
0003 | __New(typeInfo, lib)

;}
;{ [1642] more libs\ImportTypeLib-master 
...
;}
;{ [1643] more libs\ImportTypeLib-master 

;Functions:
0001 | ITL_StructureConstructor(this, ptr = 0, noInit = false)

;}
;{ [1644] more libs\ImportTypeLib-master 
...
;}
;{ [1645] more libs\ImportTypeLib-master 
...
;}
;{ [1646] more libs\ImportTypeLib-master 
...
;}
;{ [1647] more libs\ImportTypeLib-master 

;Functions:
0011 | ImportTypeLib(lib, version = "1.0")

;}
;{ [1648] more libs\ImportTypeLib-master 
...
;}
;{ [1649] more libs\ImportTypeLib-master 

;Functions:
0024 | IsInternalProperty(property)

;}
;{ [1650] more libs\ImportTypeLib-master 

;Functions:
0001 | ITL_FAILED(hr)

;}
;{ [1651] more libs\ImportTypeLib-master 

;Functions:
0001 | ITL_FormatError(hr)

;}
;{ [1652] more libs\ImportTypeLib-master 

;Functions:
0001 | ITL_FormatException(msg, detail, error, hr = "", special = false, special_msg = "")

;}
;{ [1653] more libs\ImportTypeLib-master 
...
;}
;{ [1654] more libs\ImportTypeLib-master 

;Functions:
0001 | ITL_HasEnumFlag(combi, flag)

;}
;{ [1655] more libs\ImportTypeLib-master 

;Functions:
0001 | ITL_IsComObject(obj)

;}
;{ [1656] more libs\ImportTypeLib-master 

;Functions:

;}
;{ [1657] more libs\ImportTypeLib-master 
...
;}
;{ [1658] more libs\ImportTypeLib-master 

;Functions:

;}
;{ [1659] more libs\ImportTypeLib-master 

;Functions:
0001 | ITL_ParamToVARIANT(info, tdesc, value, byRef variant, index)

;}
;{ [1660] more libs\ImportTypeLib-master 

;Functions:
0001 | ITL_SUCCEEDED(hr)

;}
;{ [1661] more libs\ImportTypeLib-master 
...
;}
;{ [1662] more libs\ImportTypeLib-master 

;Functions:
0013 | ProcessFile(path)

;}
;{ [1663] more libs\ImportTypeLib-master 

;Functions:
0001 | GetParamInfo(elem, method, index)

;}
;{ [1664] more libs\ImportTypeLib-master 

;Functions:
0069 | GetElementInfo(elem)

;}
;{ [1665] more libs\ImportTypeLib-master 
...
;}
;{ [1666] more libs\MCode-Ex-master 

;Functions:

;}
;{ [1667] more libs\MCode-Ex-master 
...
;}
;{ [1668] more libs\MCode-Ex-master 
...
;}
;{ [1669] more libs\MCode-Ex-master 
...
;}
;{ [1670] more libs\MCode-Ex-master 

;Functions:

;}
;{ [1671] more libs\MCode-Ex-master 
...
;}
;{ [1672] more libs\MCode-Ex-master 
...
;}
;{ [1674] more libs\minilib 

;Functions:
0001 | borderlessMode(winId="")

;}
;{ [1675] more libs\minilib 

;Functions:
0001 | borderlessMove(winId="",key="LButton")

;}
;{ [1676] more libs\minilib 
...
;}
;{ [1677] more libs\minilib 

;Functions:
0001 | commaFormat(num)

;}
;{ [1678] more libs\minilib 
...
;}
;{ [1679] more libs\minilib 

;Functions:
0017 | CopyDirStructure(_inpath,_outpath,_i=true)

;}
;{ [1680] more libs\minilib 

;Functions:

;}
;{ [1681] more libs\minilib 

;Functions:
0001 | dpiOffset(val)

;}
;{ [1682] more libs\minilib 

;Functions:
0008 | EmptyMem(PID=0)

;}
;{ [1683] more libs\minilib 

;Functions:

;}
;{ [1684] more libs\minilib 

;Functions:
0001 | externalIP_old()

;}
;{ [1685] more libs\minilib 

;Functions:
0005 | FileCountLines(FileName)

;}
;{ [1686] more libs\minilib 

;Functions:
0005 | FileFindWord(FileName, Search)

;}
;{ [1687] more libs\minilib 

;Functions:
0004 | FileGetVersionInfo( peFile="", StringFileInfo="" )

;}
;{ [1688] more libs\minilib 

;Functions:

;}
;{ [1689] more libs\minilib 

;Functions:
0001 | fileUnblock(path)

;}
;{ [1690] more libs\minilib 

;Functions:
0008 | if(countryIsTimezone)

;}
;{ [1691] more libs\minilib 

;Functions:
0001 | getImageSize(imagePath)

;}
;{ [1692] more libs\minilib 

;Functions:
0001 | getPosFromAngle(ByRef x2,ByRef y2,x1,y1,len,ang)

;}
;{ [1693] more libs\minilib 
...
;}
;{ [1703] more libs\minilib 

;Functions:

;}
;{ [1704] more libs\minilib 

;Functions:
0001 | invertCaseChr(char)

;}
;{ [1705] more libs\minilib 

;Functions:
0001 | invertCaseStr(str)

;}
;{ [1706] more libs\minilib 

;Functions:
0001 | is64bitExe(path)

;}
;{ [1707] more libs\minilib 

;Functions:
0001 | isAlpha(in)

;}
;{ [1708] more libs\minilib 

;Functions:
0001 | isAlphaNum(in)

;}
;{ [1709] more libs\minilib 

;Functions:
0001 | isBetween(lower,check,upper)

;}
;{ [1710] more libs\minilib 

;Functions:
0001 | isDigit(in)

;}
;{ [1711] more libs\minilib 

;Functions:
0001 | isFloat(in)

;}
;{ [1712] more libs\minilib 

;Functions:
0001 | isHex(in)

;}
;{ [1713] more libs\minilib 

;Functions:
0001 | isInt(in)

;}
;{ [1714] more libs\minilib 

;Functions:
0001 | isLower(in)

;}
;{ [1715] more libs\minilib 

;Functions:
0001 | isNum(in)

;}
;{ [1716] more libs\minilib 

;Functions:
0001 | isSpace(in)

;}
;{ [1717] more libs\minilib 

;Functions:
0001 | isUpper(in)

;}
;{ [1718] more libs\minilib 

;Functions:
0016 | json(ByRef js, s, v = "")

;}
;{ [1719] more libs\minilib 

;Functions:
0001 | lanConnected()

;}
;{ [1720] more libs\minilib 

;Functions:
0001 | min(min)

;}
;{ [1721] more libs\minilib 

;Functions:
0001 | mouseOverWin(winName,winText="")

;}
;{ [1722] more libs\minilib 

;Functions:
0001 | mtoh(hr)

;}
;{ [1723] more libs\minilib 

;Functions:
0001 | mtom(mil)

;}
;{ [1724] more libs\minilib 

;Functions:
0001 | mtos(sec)

;}
;{ [1725] more libs\minilib 
...
;}
;{ [1738] more libs\minilib 

;Functions:
0001 | strI(str)

;}
;{ [1739] more libs\minilib 

;Functions:
0001 | strReplaceI(haystack,searchText,replaceText="",byref outputVarCount="",limit=-1)

;}
;{ [1740] more libs\minilib 

;Functions:
0001 | strToLower(str)

;}
;{ [1741] more libs\minilib 

;Functions:
0001 | strToUpper(str)

;}
;{ [1742] more libs\minilib 
...
;}
;{ [1743] more libs\minilib 

;Functions:
0001 | tool(content,wait=2500,x="",y="")

;}
;{ [1744] more libs\minilib 

;Functions:

;}
;{ [1745] more libs\minilib 

;Functions:
0001 | urlDownloadToFile(url,fileDest="",method=0)

;}
;{ [1746] more libs\minilib 

;Functions:

;}
;{ [1747] more libs\minilib 

;Functions:
0010 | urlFileGetSize(url,units=0)

;}
;{ [1748] more libs\minilib 

;Functions:
0001 | winInfo(winName="A")

;}
;{ [1749] more libs\Mini_Framwork 

;Functions:

;}
;{ [1750] more libs\Mini_Framwork 

;Functions:

;}
;{ [1751] more libs\Mini_Framwork 

;Functions:

;}
;{ [1752] more libs\Mini_Framwork 

;Functions:
0057 | __New(message = "", innerException = "")

;}
;{ [1753] more libs\Mini_Framwork 
...
;}
;{ [1759] more libs\Mini_Framwork 

;Functions:
0029 | __New()

;}
;{ [1760] more libs\Mini_Framwork 
...
;}
;{ [1762] more libs\Mini_Framwork 

;Functions:
0031 | __New()

;}
;{ [1763] more libs\Mini_Framwork 
...
;}
;{ [1764] more libs\Mini_Framwork 

;Functions:
0041 | __New(key, value)

;}
;{ [1765] more libs\Mini_Framwork 
...
;}
;{ [1766] more libs\Mini_Framwork 

;Functions:
0061 | __New(message = "", innerException = "")

;}
;{ [1767] more libs\Mini_Framwork 
...
;}
;{ [1775] more libs\Mini_Framwork 

;Functions:
0060 | __New(message = "", innerException = "")

;}
;{ [1776] more libs\Mini_Framwork 
...
;}
;{ [1780] more libs\Mini_Framwork 

;Functions:
0065 | __New(message = "", innerException = "")

;}
;{ [1781] more libs\Mini_Framwork 
...
;}
;{ [1785] more libs\Mini_Framwork 

;Functions:

;}
;{ [1786] more libs\Mini_Framwork 

;Functions:
0060 | __New(message = "", innerException = "")

;}
;{ [1787] more libs\Mini_Framwork 
...
;}
;{ [1789] more libs\Mini_Framwork 

;Functions:
0065 | __New(message = "", innerException = "")

;}
;{ [1790] more libs\Mini_Framwork 

;Functions:

;}
;{ [1791] more libs\Mini_Framwork 

;Functions:

;}
;{ [1792] more libs\Mini_Framwork 

;Functions:

;}
;{ [1793] more libs\Mini_Framwork 
...
;}
;{ [1794] more libs\Mini_Framwork 

;Functions:

;}
;{ [1795] more libs\Mini_Framwork 

;Functions:
0059 | __New(message = "", innerException = "")

;}
;{ [1796] more libs\Mini_Framwork 

;Functions:
0059 | __New(message = "", innerException = "")

;}
;{ [1797] more libs\Mini_Framwork 
...
;}
;{ [1798] more libs\Mini_Framwork 

;Functions:
0059 | __New(message = "", innerException = "")

;}
;{ [1799] more libs\Mini_Framwork 
...
;}
;{ [1800] more libs\Mini_Framwork 

;Functions:
0038 | __New()

;}
;{ [1801] more libs\Mini_Framwork 
...
;}
;{ [1804] more libs\Mini_Framwork 

;Functions:
0062 | __New(message = "", innerException = "")

;}
;{ [1805] more libs\Mini_Framwork 
...
;}
;{ [1807] more libs\Mini_Framwork 

;Functions:

;}
;{ [1808] more libs\Mini_Framwork 
...
;}
;{ [1817] more libs\Mini_Framwork 

;Functions:
0059 | __New(message = "", innerException = "")

;}
;{ [1818] more libs\Mini_Framwork 
...
;}
;{ [1823] more libs\Mini_Framwork 

;Functions:
0039 | __New()

;}
;{ [1824] more libs\Mini_Framwork 
...
;}
;{ [1825] more libs\Mini_Framwork 

;Functions:

;}
;{ [1826] more libs\Mini_Framwork 

;Functions:

;}
;{ [1827] more libs\Mini_Framwork 

;Functions:
0136 | ToString()

;}
;{ [1828] more libs\Mini_Framwork 

;Functions:

;}
;{ [1829] more libs\Mini_Framwork 
...
;}
;{ [1835] more libs\RamDisk & CmdReturn 

;Functions:

;}
;{ [1836] more libs\RamDisk & CmdReturn 
...
;}
;{ [1837] more libs\SendInput-master 

;Functions:

;}
;{ [1838] more libs\SendInput-master 
...
;}
;{ [1839] more libs\SendInput-master 

;Functions:
0053 | process(str,sod)

;}
;{ [1840] more libs\SendInput-master 
