...
Gui, Add, ListView, grid x10 y+20 w380 r20 gMyListView vMyListView, Command | Hex | Decimal
...
Gui, Show, , Windows Message Search
return
...
clipboard := name
SetTimer, TT1, 3000
ToolTip, Constant name: %name%`r`n(on clipboard also)
return
}
...
clipboard := number
SetTimer, TT1, 3000
ToolTip, Constant integer value: %number%`r`n(on clipboard also)
return
}
;return
