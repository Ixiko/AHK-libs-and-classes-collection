...
;Directory = C:\Program Files\AutoHotkey\lib
FileSelectFolder, Directory, C:\Program Files\AutoHotkey\lib
...
Loop, Read, files.txt
{
	...
	If NOT (funcList="") {
		FileAppend, `;`{ %Filename% `n`n`;Functions`:`n, FileFunctionList.txt
